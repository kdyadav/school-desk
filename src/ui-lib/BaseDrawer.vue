    ...
    <Teleport to="body">
        ...
        <transition name="drawer-slide">
            <aside v-if="modelValue" :class="[
                ...
                <header class="px-5 py-4 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
                    <slot name="header">
                        <div>
                ...
                <footer v-if="$slots.footer"
                    class="px-5 py-4 border-t border-gray-200 bg-gray-50 flex gap-3 justify-end flex-shrink-0">
                    <slot name="footer" />
                </footer>
            </aside>
        </transition>
